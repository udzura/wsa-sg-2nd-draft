...
* [ ] 思考実験レベルである -> 問題意識、既存、提案をまとめてWSA研で議論する
* [ ] 実装をまだ伴っていない -> 半分ぐらいでも書く。少なくとも仕様まで書く
* [ ] 随所随所でカッコで自分にツッコミを入れてたりすること -> 整形
* [ ] 筆者はApacheのsuexecを実務で運用したことはないという点をご容赦いただきたい -> 手を動かせばええやん
